...
export declare class Subchannel implements SubchannelInterface {
    ...
    createCall(metadata: Metadata, host: string, method: string, listener: SubchannelCallInterceptingListener, callId?: number): SubchannelCall;
    /**
