...
export interface Transport {
    ...
    createCall(metadata: Metadata, host: string, method: string, listener: SubchannelCallInterceptingListener, subchannelCallStatsTracker: Partial<CallEventTracker>, callId?: number): SubchannelCall;
...
declare class Http2Transport implements Transport {
    ...
    private get traceEnabled();
    private get keepaliveTraceEnabled();
    private get flowControlTraceEnabled();
    private get internalsTraceEnabled();
    private trace;
    ...
    createCall(metadata: Metadata, host: string, method: string, listener: SubchannelCallInterceptingListener, subchannelCallStatsTracker: Partial<CallEventTracker>, callId?: number): Http2SubchannelCall;
    getChannelzRef(): SocketRef;
    getPeerName(): string;
    getOptions(): ChannelOptions;
    getAuthContext(): AuthContext;
