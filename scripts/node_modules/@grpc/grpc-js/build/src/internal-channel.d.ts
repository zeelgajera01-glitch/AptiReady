...
export declare class InternalChannel {
    ...
    removeCallFromPickQueue(call: LoadBalancingCall): void;
    ...
    private onCallStart;
    private onCallEnd;
    createLoadBalancingCall(callConfig: CallConfig, method: string, host: string, credentials: CallCredentials, deadline: Deadline, callNumber?: number): LoadBalancingCall;
    createRetryingCall(callConfig: CallConfig, method: string, host: string, credentials: CallCredentials, deadline: Deadline, callNumber?: number): RetryingCall;
