...
import type { CoreOptions, Options, Request as TeenyRequest, Response as TeenyResponse } from 'teeny-request';
...
export type MetadataCallback<K> = (err: Error | null, metadata?: K, apiResponse?: TeenyResponse) => void;
...
export interface InstanceResponseCallback<T> {
    (err: ApiError | null, instance?: T | null, apiResponse?: TeenyResponse): void;
}
