 ...
 */
import { AuthClient, GoogleAuth, GoogleAuthOptions, CredentialBody } from 'google-auth-library';
import type { CoreOptions, Options, OptionsWithUri, Response } from 'teeny-request';
...
export interface MakeWritableStreamOptions {
     ...
     */
    request?: Options;
    makeAuthenticatedRequest(reqOpts: OptionsWithUri & {
...
export declare class Util {
     ...
     */
    handleResp(err: Error | null, resp?: Response | null, body?: ResponseBody, callback?: BodyResponseCallback): void;
    /**
     ...
     */
    parseHttpRespMessage(httpRespMessage: Response): ParsedHttpRespMessage;
    /**
    ...
    decorateHeaders(headers?: CoreOptions['headers'], options?: DecorateHeadersOptions): DecorateHeadersResult;
    _getDefaultHeaders(gcclGcsCmd?: string): Headers;
}
 ...
 */
export declare function decorateHeaders(headers?: CoreOptions['headers'], options?: DecorateHeadersOptions): DecorateHeadersResult;
