...
import { BaseMetadata, RequestResponse, SetMetadataOptions } from './nodejs-common/service-object.js';
...
export declare class ComposeCleanupError extends Error {
    errors: Error[];
    newFile: File;
    apiResponse: unknown;
    constructor(message: string, errors: Error[], newFile: File, apiResponse: unknown);
}
